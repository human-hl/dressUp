...
const styles = {
    ...
    mainRow: { display: 'flex', gap: '32px', flexWrap: { xs: 'wrap', md: 'nowrap' }, mb: '24px' },
    leftCol: { flex: '1 1 45%' },
    photoBox: {
        border: '2px solid #487886', borderRadius: '12px', backgroundColor: '#FAFAFA',
        minHeight: { xs: '280px', md: '420px' }, display: 'flex', alignItems: 'center',
        justifyContent: 'center', p: '16px', height: '100%',
    },
    rightCol: { flex: '1 1 55%', display: 'flex', flexDirection: 'column' },
    sectionTitle: { fontSize: '1.1rem', fontWeight: 600, color: '#5C4E40', mb: '16px' },
    fieldsGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', mb: '16px' },
    fieldBox: { border: '1px solid #487886', borderRadius: '10px', p: '10px 14px', backgroundColor: '#FAFAFA' },
    fieldLabel: { fontSize: '0.75rem', color: '#8D6E63', mb: '2px' },
    fieldValue: { fontSize: '1rem', fontWeight: 500, color: '#5C4E40' },
    actions: { display: 'flex', gap: '12px' },
    editBtn: { backgroundColor: '#487886', color: '#FFFFFF', textTransform: 'none', fontWeight: 600, fontSize: '0.9rem', borderRadius: '20px', px: '20px', py: '10px', flex: 1, '&:hover': { backgroundColor: '#3b646f' } },
    deleteBtn: { backgroundColor: '#FED8F7', color: '#7E4886', textTransform: 'none', fontWeight: 600, fontSize: '0.9rem', borderRadius: '20px', px: '20px', py: '10px', '&:hover': { backgroundColor: '#f5c8f0' } },
};
